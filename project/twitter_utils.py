...
def get_oauth_verifier(request_token):
    # Ask the user to authorize our app and give us a the PIN code
...
def get_access_token(request_token, oauth_verifier):
    ...
    # Ask Twitter for access token, and Twitter knows it should give us it because we verified the request token token
